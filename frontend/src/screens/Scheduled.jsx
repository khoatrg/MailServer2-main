        ...
        <div style={{marginLeft:'auto', display:'flex', alignItems:'center', gap:12}}>
          ...
          {!showSearch ? (
            ...
            <div style={{display:'flex', alignItems:'center', gap:8, padding:'4px 6px', background:'#071015', border:'1px solid rgba(255,255,255,0.03)', borderRadius:8}}>
              ...
              <input ref={inputRef} value={searchQuery} onChange={e=>setSearchQuery(e.target.value)} onKeyDown={onSearchKey} placeholder="Search scheduled subject, email, or content" style={{padding:'8px 10px', borderRadius:6, border:'none', background:'transparent', color:'#dff3ff', outline:'none', width:300, maxWidth:'40vw'}} />
            ...
            <div className="message-body">
              <div className="message-top" style={{display:'flex', justifyContent:'space-between', gap:12}}>
                <div style={{flex:1}}>
                  ...
                  <div style={{color:'#9aa6b2', marginTop:6}}>To: {j.mailOptions.to}</div>
                </div>
